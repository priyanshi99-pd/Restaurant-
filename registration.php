...
<body>
 ...
 <td> <input type="email" name="email" value="" placeholder="Enter Your Email Address" required="" style="padding: 10px; width: 300%">  <br> </td>
      ...
      <tr>   
<td align="center"> <input type="submit" name="sb" value="Register Now" style="color:black; background: lightgreen; font-size: 1.3em; font-family: times new roman">  <br> </td>
   </tr>
