...
<head>
<meta charset="UTF-8" />
<title>South Indian Food Menu</title>
<style>
/* Combined Top Bar */
.topbar-container {
    display: flex;
...
<div class="main-page">
    <aside class="sidebar">
        ...
        <ul class="sidebar-list">
            ...
            <li><a href="south.php" class="active">South Indian</a></li>
    ...
    <section class="content">
        <div class="menu-container">
            <h2 style="text-align:center;margin-bottom:12px;">South Indian Food Menu</h2>
            <div class="menu-punch">Dosa, Idli, Sambar — South India's Gift to Your Taste Buds!</div>
            ...
            <div class="menu-grid">
                ...
                if ($result && mysqli_num_rows($result) > 0) {
                    ...
                    echo "<div style='grid-column:1/-1;text-align:center;color:#666;'>No South Indian dishes found.</div>";
                }
                ?>
            </div>
        </div>
