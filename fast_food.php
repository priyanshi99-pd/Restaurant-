...
<div class="main-page">
    <aside class="sidebar">
        ...
        <ul class="sidebar-list">
            ...
            <li><a href="fast_food.php" class="active">Street Food</a></li>
    ...
    <section class="content">
        <div class="menu-container">
            <h2 style="text-align:center;margin-bottom:12px;">Street Food Menu</h2>
            <div class="menu-punch">Taste the Spice of Streets — Vibrant Bites, Street Delights!</div>
            <div class="menu-grid">
                <?php
                $sql = "SELECT * FROM menu WHERE category = 'Fast Food'";
                ...
                if ($result && mysqli_num_rows($result) > 0) {
                    ...
                    echo "<div style='grid-column:1/-1;text-align:center;color:#666;'>No Street Food items found.</div>";
                }
                ?>
            </div>
        </div>
