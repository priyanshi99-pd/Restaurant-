...
<div class="main-page">
    <aside class="sidebar">
        ...
        <ul class="sidebar-list">
            <li><a href="punjabi.php" class="active">Punjabi</a></li>
    ...
    <section class="content">
        <div class="menu-container">
            <h2 style="text-align:center;margin-bottom:12px;">Punjabi Food Menu</h2>
            <div class="menu-punch">Eat Good, Feel Great — Taste Punjab in Every Bite!</div>
            ...
            <div class="menu-grid">
                ...
                if ($result && mysqli_num_rows($result) > 0) {
                    ...
                    echo "<div style='grid-column:1/-1;text-align:center;color:#666;'>No Punjabi dishes found.</div>";
                }
                ?>
            </div>
        </div>
