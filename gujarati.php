...
<head>
<meta charset="UTF-8" />
<title>Gujarati Food Menu</title>
<style>
/* Combined Top Bar */
.topbar-container {
    display: flex;
...
<div class="main-page">
    <aside class="sidebar">
        ...
        <ul class="sidebar-list">
            ...
            <li><a href="gujarati.php" class="active">Gujarati</a></li>
    ...
    <section class="content">
        <div class="menu-container">
            <h2 style="text-align:center;margin-bottom:12px;">Gujarati Food Menu</h2>
            <div class="menu-punch">Taste Gujarat — A Symphony of Sweet, Spicy & Savory!</div>
            
            <div class="menu-grid">
                <?php
                $sql = "SELECT * FROM menu WHERE category = 'Gujarati'";
                ...
                if ($result && mysqli_num_rows($result) > 0) {
                    ...
                    echo "<div style='grid-column:1/-1;text-align:center;color:#666;'>No Gujarati dishes found.</div>";
                }
                ?>
            </div>
        </div>
