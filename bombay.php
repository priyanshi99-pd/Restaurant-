...
<head>
<meta charset="UTF-8" />
<title>Bombay Special Menu</title>
<style>
/* Combined Top Bar */
.topbar-container {
    display: flex;
...
<div class="main-page">
    <aside class="sidebar">
        ...
        <ul class="sidebar-list">
            ...
            <li><a href="bombay.php" class="active">Bombay Special</a></li>
        </ul>
    </aside>
    ...
    <section class="content">
        <div class="menu-container">
            <h2 style="text-align:center;margin-bottom:12px;">Bombay Special Menu</h2>
            <div class="menu-punch">Vada Pav Isn't Just Food — It's The Spirit of Mumbai in a Bun!</div>
            
            <div class="menu-grid">
                <?php
                $sql = "SELECT * FROM menu WHERE category = 'Bombay'";
                ...
                if ($result && mysqli_num_rows($result) > 0) {
                    while ($food = mysqli_fetch_assoc($result)) {
                        ...
                        if (!empty($food["sub_cat"])) {
                            echo '<div class="menu-badge">' . htmlspecialchars($food["sub_cat"]) . '</div>';
                        }
                    ...
                    echo "<div style='grid-column:1/-1;text-align:center;color:#666;'>No Bombay Special items found.</div>";
                }
                ?>
            </div>
        </div>
